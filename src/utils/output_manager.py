...
class OutputManager:
    ...
    def save_configs(self, unique_links: List[Dict]):
        ...
        # Separate links by protocol for protocol-specific files (if needed, not in current request)
        # Or handle protocols for mixed output
        ...
        try:
            ...
            with open(file_path, 'w', encoding='utf-8') as f:
                if settings.OUTPUT_HEADER_BASE64_ENABLED:
                    ...
                    # You can customize this header as needed.
