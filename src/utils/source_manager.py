...
class SourceManager:
    ...
    # These methods are TEMPORARILY DISABLED for debugging purposes.
    # To re-enable, uncomment the calls to these methods in add_telegram_channel and add_website.
    def _should_ignore_telegram_channel(self, channel_username: str) -> bool:
        ...
        (TEMPORARILY DISABLED FOR DEBUGGING)
        """
        # print(f"SourceManager: _should_ignore_telegram_channel called for '{channel_username}' (currently disabled).")
    ...
    def _should_ignore_website_url(self, url: str) -> bool:
        ...
        (TEMPORARILY DISABLED FOR DEBUGGING)
        """
        # print(f"SourceManager: _should_ignore_website_url called for '{url}' (currently disabled).")
        # url_lower = url.lower()
