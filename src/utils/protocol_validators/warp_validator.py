...
class WarpValidator(BaseValidator):
    ...
    def is_valid(link: str) -> bool:
        ...
        try:
            ...
            # More complex ones might have a UUID or a specific parameter for teams.
            
            # If there's a netloc, it might be a UUID or an endpoint.
            ...
            # Check for common query parameters like 'name', 'orgid'
            query_params = parse_qs(parsed_url.query)
            # If 'orgid' is present, it usually indicates a Team Warp config.
